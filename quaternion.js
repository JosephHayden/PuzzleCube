...
(function(root) {
  ...
  Quaternion.prototype = {
	...
	'toEuler' : function(){
		var _x = Math.atan(2*(this['w']*this['x']+this['y']*this['z'])/(1-2*(this['x']*this['x']+this['y']*this['y'])));
		var _y = Math.asin(2*(this['w']*this['y']-this['z']*this['x']));
		var _z = Math.atan(2*(this['w']*this['z']+this['x']*this['y'])/(1-2*(this['y']*this['y']+this['z']*this['z'])));
		return [_x, _y, _z];
	  }
  };
